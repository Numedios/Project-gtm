...
réconciliation sur deux sources
        ↓
arbitrage (récence + marqueur stable/volatile)
        ↓
...
qui ne dépend d'aucun accès externe et dont les onze fixtures sont déjà conçues pour exercer la
règle d'arbitrage unique, ses garde-fous et les deux seuils de signalement.
